  ...
  return (
    <div className="profile-page">
      <div className="section-heading profile-page-heading">
        <div><p className="eyebrow">Akun MotoCare</p><h3>Profil</h3><p>Lihat detail akun, peran, dan koneksi layanan Anda.</p></div>
      </div>
      ...
      <section className="profile-section">
        <div className="profile-section-header"><User size={18} /><h3>Informasi Akun</h3></div>
        <dl className="profile-list">
          <div><dt><UserCircle size={15} />Username</dt><dd>{user?.username || '-'}</dd></div>
          <div><dt><Mail size={15} />Email</dt><dd>{user?.email || '-'}</dd></div>
          <div><dt><Shield size={15} />Peran</dt><dd><span className={roleBadgeClass}>{user?.role || '-'}</span></dd></div>
        </dl>
      </section>

      <section className="profile-section">
        <div className="profile-section-header"><KeyRound size={18} /><h3>Keamanan</h3></div>
        <dl className="profile-list">
          <div><dt><KeyRound size={15} />Autentikasi</dt><dd>Bearer Token (JWT)</dd></div>
          <div><dt><Shield size={15} />Penyimpanan Sesi</dt><dd>localStorage</dd></div>
        </dl>
      </section>
      ...
      <section className="profile-section">
        <div className="profile-section-header"><Globe size={18} /><h3>Koneksi</h3></div>
